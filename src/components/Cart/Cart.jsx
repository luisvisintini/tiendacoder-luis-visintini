              ...
              <div className="row d-flex justify-content-center align-items-center h-100">
                <div className="col">
                      ...
                      <div className="row align-items-center">
                        <div className="col-md-2">
                          <img src={producto.imagen}
                            className="img-fluid" alt={producto.nombre} width={100}/>
                        </div>
                        <div className="col-md-2 d-flex justify-content-center">
                          <div>
                            <p className="small text-muted mb-4 pb-2">Nombre</p>
                            <p className="lead fw-normal mb-0">{producto.nombre}</p>
                          </div>
                        </div>
                        <div className="col-md-2 d-flex justify-content-center">
                          <div>
                        ...
                        <div className="col-md-2 d-flex justify-content-center">
                          <div>
                            ...
                            <p className="lead fw-normal mb-0">{producto.cantidad}</p>
                          </div>
                        </div>
                        <div className="col-md-2 d-flex justify-content-center">
                          <div>
                            <p className="small text-muted mb-4 pb-2">Precio</p>
                            <p className="lead fw-normal mb-0">$ {producto.precio}</p>
                          </div>
                        </div>
                        <div className="col-md-2 d-flex justify-content-center">
                          <div>
                            <p className="small text-muted mb-4 pb-2">SubTotal</p>
                            <p className="lead fw-normal mb-0">${producto.precio * producto.cantidad}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="card-body p-4">
                      <div className="float-end">
                        <p className="mb-0 me-5 d-flex align-items-center">
                          <span className="small text-muted me-2">Total Orden:</span> <span
                            className="lead fw-bold">$ {total}</span>
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="d-flex justify-content-end">
                    <Link to="/" type="button" className="btn btn-dark btn-lg me-2">Continuar Comprando</Link>
                    <Link to="/checkout" type="button" className="btn btn-success btn-lg">Finalizar Compra</Link>
                  </div>
                </div>
              </div>
            </div>
